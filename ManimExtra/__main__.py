...
@cloup.group(
    ...
    epilog="See 'ManimExtra <command>' to read about a specific subcommand.\n\n"
    "Note: the subcommand 'ManimExtra render' is called if no other subcommand "
    "is specified. Run 'ManimExtra render --help' if you would like to know what the "
...
@click.pass_context
def main(ctx):
    """The entry point for ManimExtra."""
    pass
