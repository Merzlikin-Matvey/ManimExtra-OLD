...
# The logger can be accessed from anywhere as ManimExtra.logger, or as
# logging.getLogger("ManimExtra").  The console must be accessed as ManimExtra.console.
# Throughout the codebase, use ManimExtra.console.print() instead of print().
