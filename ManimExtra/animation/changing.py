...
from ManimExtra._config import config
...
from ManimExtra.utils.color import BLUE_B, BLUE_D, BLUE_E, GREY_BROWN, WHITE
from ManimExtra.utils.rate_functions import smooth
...
class AnimatedBoundary(VGroup):
    ...
    Examples
    --------
    .. ManimExtra:: AnimatedBoundaryExample
...
class TracedPath(VMobject, metaclass=ConvertToOpenGL):
    ...
    .. ManimExtra:: DissipatingPathExample
