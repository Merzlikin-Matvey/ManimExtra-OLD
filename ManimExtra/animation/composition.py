...
from ManimExtra.mobject.opengl.opengl_mobject import OpenGLGroup
...
if TYPE_CHECKING:
    from ManimExtra.mobject.opengl.opengl_vectorized_mobject import OpenGLVGroup
...
class LaggedStartMap(LaggedStart):
    ...
    Examples
    --------
    .. ManimExtra:: LaggedStartMapExample
