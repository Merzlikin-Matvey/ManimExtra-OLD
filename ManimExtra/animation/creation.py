...
.. ManimExtra:: CreationModule
    :hide_source:

    from ManimExtra import ManimBanner
    class CreationModule(Scene):
        def construct(self):
            ...
            texts = [Text("ManimExtra", font_size=29), Text("ManimExtra", font_size=29)]
...
class DrawBorderThenFill(Animation):
    ...
    Examples
    --------
    .. ManimExtra:: ShowDrawBorderThenFill
...
class Write(DrawBorderThenFill):
    ...
    Check that creating empty :class:`.Write` animations works::
        ...
        >>> from ManimExtra import Write, Text
        >>> Write(Text(''))
        Write(Text(''))
    """
...
class Unwrite(Write):
    ...
    .. ManimExtra:: UnwriteReverseFalse
...
class ShowIncreasingSubsets(Animation):
    ...
    .. ManimExtra:: ShowIncreasingSubsetsScene
