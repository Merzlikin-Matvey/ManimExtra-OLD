...
if typing.TYPE_CHECKING:
    from ManimExtra.mobject.geometry.line import Arrow
...
class GrowFromPoint(Transform):
    ...
    .. ManimExtra :: GrowFromPointExample
...
class GrowFromCenter(GrowFromPoint):
    ...
    .. ManimExtra :: GrowFromCenterExample
...
class GrowFromEdge(GrowFromPoint):
    ...
    .. ManimExtra :: GrowFromEdgeExample
...
class SpinInFromNothing(GrowFromCenter):
    ...
    .. ManimExtra :: SpinInFromNothingExample
