...
from ManimExtra.mobject.opengl.opengl_mobject import OpenGLGroup, OpenGLMobject
...
class Transform(Animation):
    ...
    path_arc
        ...
        See also :func:`ManimExtra.utils.paths.path_along_arc`.
    path_arc_axis
...
class ReplacementTransform(Transform):
    ...
    .. ManimExtra:: ReplacementTransformOrTransform
        :quality: low
...
class CounterclockwiseTransform(Transform):
    ...
    .. ManimExtra:: CounterclockwiseTransform_vs_Transform
...
class MoveToTarget(Transform):
    ...
    .. ManimExtra:: MoveToTargetExample
...
class ScaleInPlace(ApplyMethod):
    ...
    .. ManimExtra:: ScaleInPlaceExample
...
class ShrinkToCenter(ScaleInPlace):
    ...
    .. ManimExtra:: ShrinkToCenterExample
...
class CyclicReplace(Transform):
    ...
    Examples
    --------
    .. ManimExtra :: CyclicReplaceExample
...
class FadeTransform(Transform):
    ...
    .. ManimExtra:: DifferentFadeTransforms
...
class FadeTransformPieces(FadeTransform):
    ...
    Examples
    --------
    .. ManimExtra:: FadeTransformSubmobjects
