...
Manim's cfg subcommand is accessed in the command-line interface via ``ManimExtra
...
This will be used when running the ManimExtra command. If you want to override this config,
you will have to create a ManimExtra.cfg in the local directory, where you want those changes to be overridden."""

    CWD_CONFIG_MSG = f"""A configuration file at [yellow]{config_paths[2]}[/yellow] has been created.
To save your config please save that file and place it in your current working directory, from where you run the ManimExtra command."""
...
Are you sure you want to continue? (y/n)""",
    ...
    if proceed:
        ...
        ctx.invoke(write)
        from_path = Path.cwd() / "ManimExtra.cfg"
        to_path = directory_path / "ManimExtra.cfg"
