...
from ManimExtra.utils.iterables import adjacent_pairs
...
if TYPE_CHECKING:
    ...
    from ManimExtra.mobject.text.tex_mobject import SingleStringMathTex, Tex
...
class ArcBetweenPoints(Arc):
    ...
    Example
    -------
    .. ManimExtra:: ArcBetweenPointsExample
...
class Circle(Arc):
    ...
    def point_at_angle(self, angle: float):
        ...
        Examples
        --------
        .. ManimExtra:: PointAtAngleExample
            :save_last_frame:
    ...
    def from_three_points(
        ...
        Example
        -------
        .. ManimExtra:: CircleFromPointsExample
            :save_last_frame:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(label, str):
            from ManimExtra import MathTex
...
class AnnularSector(Arc):
    ...
    Examples
    --------
    .. ManimExtra:: AnnularSectorExample
        :save_last_frame:
...
class CubicBezier(VMobject, metaclass=ConvertToOpenGL):
    ...
    Example
    -------
    .. ManimExtra:: BezierSplineExample
        :save_last_frame:
...
class ArcPolygon(VMobject, metaclass=ConvertToOpenGL):
    ...
    arcs : :class:`list`
        The arcs created from the input parameters::
            ...
            >>> from ManimExtra import ArcPolygon
...
class ArcPolygonFromArcs(VMobject, metaclass=ConvertToOpenGL):
    ...
    arcs
        The arcs used to initialize the ArcPolygonFromArcs::
            ...
            >>> from ManimExtra import ArcPolygonFromArcs, Arc, ArcBetweenPoints
