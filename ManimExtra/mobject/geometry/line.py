...
from ManimExtra.mobject.geometry.arc import Arc, ArcBetweenPoints, Dot, TipableVMobject
from ManimExtra.mobject.geometry.tips import ArrowTriangleFilledTip
...
from ManimExtra.mobject.types.vectorized_mobject import DashedVMobject, VGroup, VMobject
...
class Arrow(Line):
    ...
    Examples
    --------
    .. ManimExtra:: ArrowExample
        :save_last_frame:

        from ManimExtra.mobject.geometry.tips import ArrowSquareTip
...
class Vector(Arrow):
    ...
    def coordinate_label(
        ...
        **kwargs,
        ...
        Examples
        --------
        .. ManimExtra:: VectorCoordinateLabel
            :save_last_frame:
...
class DoubleArrow(Arrow):
    ...
    Examples
    --------
    .. ManimExtra:: DoubleArrowExample
        :save_last_frame:

        from ManimExtra.mobject.geometry.tips import ArrowCircleFilledTip
    ...
    .. ManimExtra:: DoubleArrowExample2
        :save_last_frame:
...
class Angle(VMobject, metaclass=ConvertToOpenGL):
    ...
    **kwargs
    ...
    .. ManimExtra:: RightArcAngleExample
        :save_last_frame:
    ...
    def from_three_points(
        ...
        **kwargs
        ...
        Examples
        --------
        .. ManimExtra:: AngleFromThreePointsExample
            :save_last_frame:
