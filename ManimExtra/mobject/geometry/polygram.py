...
from ManimExtra.mobject.geometry.arc import ArcBetweenPoints
...
from ManimExtra.utils.iterables import adjacent_n_tuples, adjacent_pairs
from ManimExtra.utils.space_ops import angle_between_vectors, normalize, regular_vertices
...
class Polygram(VMobject, metaclass=ConvertToOpenGL):
    ...
    def round_corners(
        ...
        Examples
        --------
        .. ManimExtra:: PolygramRoundCorners
            :save_last_frame:
...
class RegularPolygram(Polygram):
    ...
    Examples
    --------
    .. ManimExtra:: RegularPolygramExample
        :save_last_frame:
...
class RegularPolygon(RegularPolygram):
    ...
    Examples
    --------
    .. ManimExtra:: RegularPolygonExample
        :save_last_frame:
...
class Star(Polygon):
    ...
    .. ManimExtra:: DifferentDensitiesExample
        :save_last_frame:
...
class RoundedRectangle(Rectangle):
    ...
    Examples
    --------
    .. ManimExtra:: RoundedRectangleExample
        :save_last_frame:
