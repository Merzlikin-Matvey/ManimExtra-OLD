...
from ManimExtra.utils.color import BLACK, RED, YELLOW, Color, Colors
...
class SurroundingRectangle(RoundedRectangle):
    ...
    Examples
    --------
    .. ManimExtra:: SurroundingRectExample
        :save_last_frame:
...
class BackgroundRectangle(SurroundingRectangle):
    ...
    Examples
    --------
    .. ManimExtra:: ExampleBackgroundRectangle
        :save_last_frame:
