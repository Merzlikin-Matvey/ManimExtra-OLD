...
from ManimExtra.animation.creation import Create, Uncreate
from ManimExtra.mobject.geometry.arc import Dot, LabeledDot
from ManimExtra.mobject.geometry.line import Line
from ManimExtra.mobject.mobject import Mobject, override_animate
...
from ManimExtra.utils.color import BLACK
...
class GenericGraph(VMobject, metaclass=ConvertToOpenGL):
    ...
    def from_networkx(
        ...
        **kwargs
        ...
        .. ManimExtra:: ImportNetworkxGraph
...
class Graph(GenericGraph):
    ...
    .. ManimExtra:: GraphManualPosition
        :save_last_frame:
    ...
    .. ManimExtra:: LabeledModifiedGraph
        :save_last_frame:
...
class DiGraph(GenericGraph):
    ...
    .. ManimExtra:: UndirectedMovingDiGraph
