...
from ManimExtra.mobject.geometry.arc import Circle, Dot
from ManimExtra.mobject.geometry.line import Arrow, DashedLine, Line
from ManimExtra.mobject.geometry.polygram import Polygon, Rectangle, RegularPolygon
from ManimExtra.mobject.graphing.functions import ImplicitFunction, ParametricFunction
from ManimExtra.mobject.graphing.number_line import NumberLine
from ManimExtra.mobject.graphing.scale import LinearBase
from ManimExtra.mobject.opengl.opengl_compatibility import ConvertToOpenGL
from ManimExtra.mobject.opengl.opengl_surface import OpenGLSurface
from ManimExtra.mobject.text.tex_mobject import MathTex
from ManimExtra.mobject.three_d.three_dimensions import Surface
from ManimExtra.mobject.types.vectorized_mobject import (
    VDict,
    VectorizedPoint,
    VGroup,
    VMobject,
...
from ManimExtra.utils.config_ops import merge_dicts_recursively, update_dict_recursively
from ManimExtra.utils.simple_functions import binary_search
from ManimExtra.utils.space_ops import angle_of_vector
...
class CoordinateSystem:
    ...
    def polar_to_point(self, radius: float, azimuth: float) -> np.ndarray:
        ...
        Examples
        --------
        .. ManimExtra:: PolarToPointExample
    ...
    def get_x_axis_label(
        ...
        **kwargs,
        ...
        Examples
        --------
        .. ManimExtra:: GetXAxisLabelExample
            :save_last_frame:
    ...
    def get_y_axis_label(
        ...
        **kwargs,
        ...
        Examples
        --------
        .. ManimExtra:: GetYAxisLabelExample
            :save_last_frame:
    ...
    def get_vertical_line(self, point: Sequence[float], **kwargs) -> Line:
        ...
        Examples
        --------
        .. ManimExtra:: GetVerticalLineExample
            :save_last_frame:
    ...
    def get_horizontal_line(self, point: Sequence[float], **kwargs) -> Line:
        ...
        Examples
        --------
        .. ManimExtra:: GetHorizontalLineExample
            :save_last_frame:
    ...
    def get_lines_to_point(self, point: Sequence[float], **kwargs) -> VGroup:
        ...
        Examples
        --------
        .. ManimExtra:: GetLinesToPointExample
            :save_last_frame:
    ...
    def plot_parametric_curve(
        ...
        **kwargs,
        ...
        Example
        -------
        .. ManimExtra:: ParametricCurveExample
            :save_last_frame:
    ...
    def input_to_graph_point(
        ...
        Examples
        --------
        .. ManimExtra:: InputToGraphPointExample
            :save_last_frame:
    ...
    def get_graph_label(
        ...
        Examples
        --------
        .. ManimExtra:: GetGraphLabelExample
            :save_last_frame:
    ...
    def get_riemann_rectangles(
        ...
        Examples
        --------
        .. ManimExtra:: GetRiemannRectanglesExample
            :save_last_frame:
    ...
    def plot_derivative_graph(
        ...
        Examples
        --------
        .. ManimExtra:: DerivativeGraphExample
            :save_last_frame:
    ...
    def plot_antiderivative_graph(
        ...
        **kwargs,
        ...
        Examples
        --------
        .. ManimExtra:: AntiderivativeExample
            :save_last_frame:
    ...
    def get_secant_slope_group(
        ...
        Examples
        --------
         .. ManimExtra:: GetSecantSlopeGroupExample
            :save_last_frame:
    ...
    def get_vertical_lines_to_graph(
        ...
        **kwargs,
        ...
        Examples
        --------
        .. ManimExtra:: GetVerticalLinesToGraph
            :save_last_frame:
...
class Axes(VGroup, CoordinateSystem, metaclass=ConvertToOpenGL):
    ...
    .. ManimExtra:: AxesWithDifferentTips
        :save_last_frame:
    ...
    def point_to_coords(self, point: Sequence[float]) -> np.ndarray:
        ...
        .. code-block:: pycon
            ...
            >>> from ManimExtra import Axes, RIGHT
            >>> import numpy as np
    ...
    def get_axis_labels(
        ...
        Examples
        --------
        .. ManimExtra:: GetAxisLabelsExample
            :save_last_frame:
...
class ThreeDAxes(Axes):
    ...
    def get_z_axis_label(
        ...
        **kwargs,
        ...
        Examples
        --------
        .. ManimExtra:: GetZAxisLabelExample
            :save_last_frame:
...
class ComplexPlane(NumberPlane):
    ...
    Examples
    --------
    .. ManimExtra:: ComplexPlaneExample
        :save_last_frame:
    ...
    def point_to_number(self, point: Sequence[float]) -> complex:
        ...
        ----------
        point
            The point in ManimExtra's coordinate-system
