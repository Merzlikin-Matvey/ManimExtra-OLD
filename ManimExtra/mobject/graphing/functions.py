...
from ManimExtra.utils.color import YELLOW
...
class ParametricFunction(VMobject, metaclass=ConvertToOpenGL):
    ...
    Examples
    --------
    .. ManimExtra:: PlotParametricFunction
        :save_last_frame:
    ...
    .. ManimExtra:: ThreeDParametricSpring
        :save_last_frame:
    ...
    .. ManimExtra:: DiscontinuousExample
        :save_last_frame:
...
class FunctionGraph(ParametricFunction):
    ...
    Examples
    --------
    .. ManimExtra:: ExampleFunctionGraph
        :save_last_frame:
...
class ImplicitFunction(VMobject, metaclass=ConvertToOpenGL):
    def __init__(
        ...
        **kwargs,
        ...
        Examples
        --------
        .. ManimExtra:: ImplicitFunctionExample
            :save_last_frame:
