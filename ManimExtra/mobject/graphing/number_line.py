...
if TYPE_CHECKING:
    from ManimExtra.mobject.geometry.tips import ArrowTip
...
from ManimExtra.mobject.graphing.scale import LinearBase, _ScaleBase
from ManimExtra.mobject.text.numbers import DecimalNumber
from ManimExtra.mobject.text.tex_mobject import MathTex, Tex
from ManimExtra.mobject.types.vectorized_mobject import VGroup, VMobject
from ManimExtra.utils.bezier import interpolate
from ManimExtra.utils.config_ops import merge_dicts_recursively
from ManimExtra.utils.space_ops import normalize
...
class NumberLine(Line):
    ...
    def number_to_point(self, number: float | np.ndarray) -> np.ndarray:
        ...
        --------
            ...
            >>> from ManimExtra import NumberLine
