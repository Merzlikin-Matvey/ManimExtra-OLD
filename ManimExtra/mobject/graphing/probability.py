...
from ManimExtra.mobject.geometry.polygram import Rectangle
from ManimExtra.mobject.graphing.coordinate_systems import Axes
from ManimExtra.mobject.mobject import Mobject
from ManimExtra.mobject.opengl.opengl_mobject import OpenGLMobject
from ManimExtra.mobject.svg.brace import Brace
...
class BarChart(Axes):
    ...
    def get_bar_labels(
        ...
        Examples
        --------
        .. ManimExtra:: GetBarLabelsExample
            :save_last_frame:
    ...
    def change_bar_values(self, values: Iterable[float], update_colors: bool = True):
        ...
        Examples
        --------
        .. ManimExtra:: ChangeBarValuesExample
            :save_last_frame:
