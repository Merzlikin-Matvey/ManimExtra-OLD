...
class DecimalMatrix(Matrix):
    ...
    .. ManimExtra:: DecimalMatrixExample
        :save_last_frame:
...
class IntegerMatrix(Matrix):
    ...
    .. ManimExtra:: IntegerMatrixExample
        :save_last_frame:
...
class MobjectMatrix(Matrix):
    ...
    .. ManimExtra:: MobjectMatrixExample
        :save_last_frame:
...
def get_det_text(
    ...
    .. ManimExtra:: DeterminantOfAMatrix
        :save_last_frame:
