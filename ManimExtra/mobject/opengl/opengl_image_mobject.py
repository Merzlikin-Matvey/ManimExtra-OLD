...
from ManimExtra.mobject.opengl.opengl_surface import OpenGLSurface, OpenGLTexturedSurface
from ManimExtra.utils.images import get_full_raster_image_path
        ...
        if isinstance(image_file, (str, Path)):
            ...
            return (
                ...
                .resize(
                    ...
                    * 200,  # assumption of 200 ppmu (pixels per ManimExtra unit) would suffice
