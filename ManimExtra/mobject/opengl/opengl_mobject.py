...
from ManimExtra.utils.bezier import integer_interpolate, interpolate
from ManimExtra.utils.color import *
from ManimExtra.utils.color import Colors
from ManimExtra.utils.config_ops import _Data, _Uniforms

# from ..utils.iterables import batch_by_property
from ManimExtra.utils.iterables import (
    batch_by_property,
    list_update,
    listify,
    make_even,
...
from ManimExtra.utils.paths import straight_path
from ManimExtra.utils.simple_functions import get_parameters
from ManimExtra.utils.space_ops import (
...
class OpenGLMobject:
    ...
    # _Data and _Uniforms are set as class variables to tell ManimExtra how to handle setting/getting these attributes later.
    points = _Data()
    bounding_box = _Data()
    rgbas = _Data()
    ...
    def set_default(cls, **kwargs):
        ...
        ::
            ...
            >>> from ManimExtra import Square, GREEN
    ...
    def animate(self):
        ...
        .. ManimExtra:: AnimateChainExample
        ...
        .. ManimExtra:: AnimateWithArgsExample
    ...
    def invert(self, recursive=False):
        ...
        .. ManimExtra:: InvertSumobjectsExample
    ...
    def shuffle(self, recurse=False):
        ...
        .. ManimExtra:: ShuffleSubmobjectsExample
    ...
    def scale(
        ...
        **kwargs,
        ...
        .. ManimExtra:: MobjectScaleExample
            :save_last_frame:
    ...
    def add_background_rectangle(
        ...
        """
        from ManimExtra.mobject.geometry.shape_matchers import BackgroundRectangle
    ...
    def get_shader_wrapper(self):
        from ManimExtra.renderer.shader_wrapper import ShaderWrapper
...
class _AnimationBuilder:
    ...
    def build(self):
        from ManimExtra.animation.transform import _MethodAnimation
...
def override_animate(method):
    ...
    .. ManimExtra:: AnimationOverrideExample
