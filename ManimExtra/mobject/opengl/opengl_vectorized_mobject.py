...
from ManimExtra.mobject.opengl.opengl_mobject import OpenGLMobject, OpenGLPoint
from ManimExtra.renderer.shader_wrapper import ShaderWrapper
from ManimExtra.utils.bezier import (
    bezier,
...
from ManimExtra.utils.config_ops import _Data
from ManimExtra.utils.iterables import listify, make_even, resize_with_interpolation
...
class OpenGLVGroup(OpenGLVMobject):
    ...
    .. doctest::
        ...
        >>> from ManimExtra import Triangle, Square
        >>> from ManimExtra.opengl import OpenGLVGroup
        >>> config.renderer
...
class OpenGLCurvesAsSubmobjects(OpenGLVGroup):
    ...
    Examples
    --------
    .. ManimExtra:: LineGradientExample
        :save_last_frame:
...
class OpenGLDashedVMobject(OpenGLVMobject):
    ...
    Examples
    --------
    .. ManimExtra:: DashedVMobjectExample
        :save_last_frame:
