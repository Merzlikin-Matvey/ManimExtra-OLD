...
from ManimExtra.mobject.geometry.polygram import Polygon
from ManimExtra.mobject.geometry.shape_matchers import BackgroundRectangle
from ManimExtra.mobject.text.numbers import DecimalNumber, Integer
from ManimExtra.mobject.text.tex_mobject import MathTex
from ManimExtra.mobject.text.text_mobject import Paragraph
...
class Table(VGroup):
    ...
    .. ManimExtra:: BackgroundRectanglesExample
        :save_last_frame:
    ...
    def get_horizontal_lines(self) -> VGroup:
        ...
        .. ManimExtra:: GetHorizontalLinesExample
            :save_last_frame:
    ...
    def get_vertical_lines(self) -> VGroup:
        ...
        .. ManimExtra:: GetVerticalLinesExample
            :save_last_frame:
    ...
    def set_column_colors(self, *colors: Iterable[Color]) -> Table:
        ...
        .. ManimExtra:: SetColumnColorsExample
            :save_last_frame:
    ...
    def set_row_colors(self, *colors: Iterable[Color]) -> Table:
        ...
        .. ManimExtra:: SetRowColorsExample
            :save_last_frame:
    ...
    def get_entries_without_labels(
        ...
        .. ManimExtra:: GetEntriesWithoutLabelsExample
            :save_last_frame:
    ...
    def get_row_labels(self) -> VGroup:
        ...
        .. ManimExtra:: GetRowLabelsExample
            :save_last_frame:
    ...
    def get_col_labels(self) -> VGroup:
        ...
        .. ManimExtra:: GetColLabelsExample
            :save_last_frame:
    ...
    def get_highlighted_cell(
        ...
        .. ManimExtra:: GetHighlightedCellExample
            :save_last_frame:
    ...
    def add_highlighted_cell(
        ...
        .. ManimExtra:: AddHighlightedCellExample
            :save_last_frame:
...
class MobjectTable(Table):
    ...
    .. ManimExtra:: MobjectTableExample
        :save_last_frame:
...
class IntegerTable(Table):
    ...
    .. ManimExtra:: IntegerTableExample
        :save_last_frame:
...
class DecimalTable(Table):
    ...
    .. ManimExtra:: DecimalTableExample
        :save_last_frame:
