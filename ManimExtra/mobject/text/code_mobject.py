...
from ManimExtra import logger
from ManimExtra.constants import *
from ManimExtra.mobject.geometry.arc import Dot
from ManimExtra.mobject.geometry.polygram import RoundedRectangle
...
from ManimExtra.utils.color import WHITE
...
class Code(VGroup):
    ...
    .. ManimExtra:: CodeFromString
        :save_last_frame:

        class CodeFromString(Scene):
            def construct(self):
                code = '''from ManimExtra import Scene, Square
