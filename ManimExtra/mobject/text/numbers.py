...
from ManimExtra.mobject.text.tex_mobject import MathTex, SingleStringMathTex, Tex
...
class DecimalNumber(VMobject, metaclass=ConvertToOpenGL):
    ...
    .. ManimExtra:: MovingSquareWithUpdaters
...
class Variable(VMobject, metaclass=ConvertToOpenGL):
    ...
    .. ManimExtra:: VariablesWithValueTracker
