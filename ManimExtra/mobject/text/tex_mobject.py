...
from ManimExtra.mobject.types.vectorized_mobject import VectorizedPoint, VGroup, VMobject
from ManimExtra.utils.tex import TexTemplate
from ManimExtra.utils.tex_file_writing import tex_to_svg_file
...
class SingleStringMathTex(SVGMobject):
    ...
    def font_size(self, font_val):
        if font_val <= 0:
            ...
            # sometimes ManimExtra generates a SingleStringMathex mobject with 0 height.
...
class BulletedList(Tex):
    ...
    .. ManimExtra:: BulletedListExample
        :save_last_frame:
...
class Title(Tex):
    ...
    .. ManimExtra:: TitleExample
        ...
        class TitleExample(Scene):
            def construct(self):
                banner = ManimBanner()
                title = Title(f"Manim version {ManimExtra.__version__}")
