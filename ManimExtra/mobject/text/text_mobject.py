...
from ManimExtra.mobject.svg.svg_mobject import SVGMobject
from ManimExtra.mobject.types.vectorized_mobject import VGroup, VMobject
from ManimExtra.utils.color import Colors, color_gradient
from ManimExtra.utils.deprecation import deprecated
...
class Text(SVGMobject):
    ...
    .. ManimExtra:: TextItalicAndBoldExample
        :save_last_frame:
        ...
        class TextItalicAndBoldExample(Scene):
            def construct(self):
                ...
                text6 = Text(
                    "Visit us at docs.ManimExtra.community",
                    t2c={"docs.ManimExtra.community": YELLOW},
    ...
    .. ManimExtra:: TextMoreCustomization
            :save_last_frame:
...
class MarkupText(SVGMobject):
    ...
    **What is PangoMarkup?**
    ...
    .. ManimExtra:: MarkupElaborateExample
        :save_last_frame:
