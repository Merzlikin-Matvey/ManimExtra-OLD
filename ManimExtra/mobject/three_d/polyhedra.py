...
from ManimExtra.mobject.graph import Graph
from ManimExtra.mobject.three_d.three_dimensions import Dot3D
...
class Polyhedron(VGroup):
    ...
    .. ManimExtra:: PolyhedronSubMobjects
        :save_last_frame:
