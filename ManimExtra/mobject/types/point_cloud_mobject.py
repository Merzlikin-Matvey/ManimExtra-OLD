...
from ManimExtra.mobject.opengl.opengl_point_cloud_mobject import OpenGLPMobject
...
class PointCloudDot(Mobject1D):
    ...
    Examples
    --------
    .. ManimExtra:: PointCloudDotExample
        :save_last_frame:
    ...
    .. ManimExtra:: PointCloudDotExample2
