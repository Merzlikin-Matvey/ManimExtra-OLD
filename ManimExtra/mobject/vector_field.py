...
from ManimExtra.animation.updaters.update import UpdateFromAlphaFunc
from ManimExtra.mobject.geometry.line import Vector
from ManimExtra.mobject.graphing.coordinate_systems import CoordinateSystem
...
class VectorField(VGroup):
    ...
    def scale_func(
        ...
        Examples
        --------
        .. ManimExtra:: ScaleVectorFieldFunction
...
class StreamLines(VectorField):
    ...
    .. ManimExtra:: SpawningAndFlowingArea
        :save_last_frame:
