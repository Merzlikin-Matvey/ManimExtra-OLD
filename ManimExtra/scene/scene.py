...
from ManimExtra.scene.section import DefaultSectionType
...
from ManimExtra.mobject.opengl.opengl_mobject import OpenGLPoint
...
class Scene:
    ...
    mobjects and animations.  Generally speaking, a ManimExtra script consists of a class
    ...
    def construct(self):
        ...
        Examples
        --------
        A typical ManimExtra script includes a class derived from :class:`Scene` with an
    ...
    def interactive_embed(self):
        ...
        def ipython(shell, namespace):
            import ManimExtra.opengl

            def load_module_into_namespace(module, namespace):
                for name in dir(module):
                    namespace[name] = getattr(module, name)

            load_module_into_namespace(ManimExtra, namespace)
            load_module_into_namespace(ManimExtra.opengl, namespace)
