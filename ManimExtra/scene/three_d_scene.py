...
from ManimExtra.mobject.graphing.coordinate_systems import ThreeDAxes
from ManimExtra.mobject.opengl.opengl_mobject import OpenGLMobject
from ManimExtra.mobject.three_d.three_dimensions import Sphere
from ManimExtra.mobject.value_tracker import ValueTracker
...
class ThreeDScene(Scene):
    ...
    def move_camera(
        ...
        **kwargs,
        ...
        # These lines are added to improve performance. If ManimExtra thinks that frame_center is moving,
        # it is required to redraw every object. These lines remove frame_center from the Scene once
        # its animation is done, ensuring that ManimExtra does not think that it is moving. Since the
