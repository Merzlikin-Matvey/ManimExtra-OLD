...
from ManimExtra import __version__, config, logger
...
def add_import_statement(file: Path):
    ...
    with file.open("r+") as f:
        import_line = "from ManimExtra import *"
        content = f.read()
        f.seek(0)
        f.write(import_line + "\n" + content)
...
def copy_template_files(
    ...
    copyfile(template_cfg_path, Path.resolve(project_dir / "ManimExtra.cfg"))
    console.print("\n\t[green]copied[/green] [blue]ManimExtra.cfg[/blue]\n")
