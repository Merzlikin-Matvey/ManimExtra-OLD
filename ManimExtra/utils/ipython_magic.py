...
from ManimExtra import Group, config, logger, tempconfig
from ManimExtra.__main__ import main
from ManimExtra.renderer.shader import shader_program_cache
    ...
    class ManimMagic(Magics):
        ...
        def manim(
            ...
            Usage in line mode::
                ...
                %ManimExtra [CLI options] MyAwesomeScene
            ...
            Run ``%ManimExtra --help`` and ``%ManimExtra render --help`` for possible command line interface options.
            ...
            .. note::
                ...
                documentation with Sphinx and JupyterBook. See also the :mod:`ManimExtra directive for Sphinx
                <ManimExtra.utils.docbuild.manim_directive>`.

            Examples
            --------

            First make sure to put ``import ManimExtra``, or even ``from ManimExtra import *``
            in a cell and evaluate it. Then, a typical Jupyter notebook cell for Manim
            could look as follows::

                %%ManimExtra -v WARNING --disable_caching -qm BannerExample
            ...
            if not len(args) or "-h" in args or "--help" in args or "--version" in args:
                main(args, standalone_mode=False, prog_name="ManimExtra")
                return

            modified_args = self.add_additional_args(args)
            args = main(modified_args, standalone_mode=False, prog_name="ManimExtra")
