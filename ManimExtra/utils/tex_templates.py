...
# This file makes TexTemplateLibrary and TexFontTemplates available for use in ManimExtra Tex and MathTex objects.
...
class TexTemplateLibrary:
    ...
    """An instance of the default TeX template in ManimExtra"""
...
class TexFontTemplates:
    ...
    To experiment, try to render the TexFontTemplateLibrary example scene:
         ``ManimExtra path/to/ManimExtra/example_scenes/advanced_tex_fonts.py TexFontTemplateLibrary -p -ql``
    """
